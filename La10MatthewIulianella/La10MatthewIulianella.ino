...
// Student Number: 2231994
// Date: 4/1/2026
// Lab Name: Lab Procedure #10: Visualization
...
void reactionGame() {
  ...
  // !!! ENTER THE CODE HERE !!!
  int randNum= random(3,6); // Using the random function to generate a random delay
  ...
  unsigned long reactionTime = millis() - startTime; // millis() is current time and it gets subtracted by startTime
  ...
  lcd.print(" ms");
  Serial.println(reactionTime); // Needed to have the serial monitor display the same value
